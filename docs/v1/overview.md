...
A formally versioned `v1` API is planned for a future release. It will provide long-term stability guarantees and be announced in the [changelog](../changelog) before going live.
